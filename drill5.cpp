...
try {
	...
	vector<int> v1(10); v[5] = 7; if (v1[5]!=7) cout << "6. Success!\n";

	//7. if (cond) cout << "Success!\n"; else cout << "Fail!\n";
	bool cond = true;//deklarálni kell hogy működjön
	...
	//int x1 = 2; double d = 5/(x-2); if (d==2*x+0.5) cout << "21. Success!\n";

	//22. string<char> s = "Success!\n"; for (int i=0; i<=10; ++i) cout << s[i];
	string s6 = "22. Success!\n"; for (int i=0; i<=s6.size(); ++i) cout << s6[i];

	//23. int i=0; while (i<10) ++j; if (j<i) cout << "Success!\n";
	int i1=0; while (i<10) ++i; if (j<i) cout << "23. Success!\n";

	//24. int x = 4; double d = 5/(x-2); if (d=2*x+0.5) cout << "Success!\n";
	int x1 = 4; double d = 5/(x1-2); if (d==2*x1+0.5) cout << "24. Success!\n";
